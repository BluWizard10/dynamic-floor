...
## [2.0.0-beta.1]
### Changes
- Switched to `VRC Raycast` to control Floor Collider position. Way more accurate and optimized than using Constraints!
  - **This requires VRChat SDK 3.10.3 or newer!**
- VRCFury no longer required. If not using, delete the Toggle object in the prefab.
- Bumped minimum version requirement of `VRChat SDK - Avatars` to greater than or equal to `3.10.3`.
